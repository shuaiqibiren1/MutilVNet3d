...
if __name__ == '__main__':
    ...
    parser.add_argument('mode', choices=['train_and_val', 'augtrain'], help='Select the mode to run')
    args = parser.parse_args()

    if args.mode == 'train_and_val':
        save_file2csv(r'/root/workplace/data/MM-WHS2017/trainstage/train', 'data/traindata.csv')
        save_file2csv(r'/root/workplace/data/MM-WHS2017/trainstage/validation', 'data/validata.csv')
    elif args.mode == 'augtrain':
        save_file2csv(r'/root/workplace/data/MM-WHS2017/trainstage/augtrain', 'data/trainaugdata.csv')
