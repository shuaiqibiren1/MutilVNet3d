...
import sys
sys.path.append('/root/workplace/PytorchDeepLearing/')
...
def preparetraindata():
    ...
    :return:
    """
    src_train_path = r"/root/workplace/data/MM-WHS2017/processtage/train"
    source_process_path = r"/root/workplace/data/MM-WHS2017/trainstage/train"
...
def preparevalidationdata():
    ...
    src_train_path = r"/root/workplace/data/MM-WHS2017/processtage/validation"
    source_process_path = r"/root/workplace/data/MM-WHS2017/trainstage/validation"
    outputimagepath = source_process_path + "/" + image_dir
    outputlabelpath = source_process_path + "/" + mask_dir
    preparesampling3dtraindata(src_train_path, outputimagepath, outputlabelpath, (112, 112, 128))
