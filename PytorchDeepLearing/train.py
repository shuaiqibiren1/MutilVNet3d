...
def trainmutilvnet3d():
    ...
    csvdataaug = pd.read_csv('dataprocess/data/trainaugdata.csv')
    ...
    vnet3d = MutilVNet3dModel(image_depth=128, image_height=112, image_width=112, image_channel=1, numclass=8,
